  ...
  const addUserLikes = async (clickedUserId) => {
    ...
    try {
      ...
      if (!user) {
        ...
        const response = await axios.post(`${removeLike}/${clickedUserId}`, {
          username: username,
        });
        setLike((prev) => !prev);
        ...
        if (response.data === 'USER NOT FOUND') {
          ...
          try {
            ...
            const response = await axios.post(`${addLike}/${clickedUserId}`, {
              username: username,
              userId: id,
            });
            ...
            <div className="box boxItems" key={item._id}>
              ...
              <div className="details">
                ...
                <div className="date">
                  ...
                  {count === 0 && (
                    <>
                      <AiFillLike
                        ...
                        onClick={() => addUserLikes(item._id)}
                      />{' '}
                      <label htmlFor="">{item.likes.length}</label>
                    </>
                  )}
                  {count > 0 && (
                    <>
                  ...
                  <div style={{ color: 'black' }}>{(count = 0)}</div>
                  <AiOutlineComment
                                ...
                                <CardContent>
                                  ...
                                  >
                                    ...
                                    <GiPartyPopper
                                      ...
                                      style={{ fontSize: '30px' }}
                                    />{' '}
                                    <BsFillEmojiHeartEyesFill color="#FFAE42" />{' '}
                                    {item.announcementArray.announcement}
                                  </Typography>
                                </CardContent>
                              </CardActionArea>
                            </Card>
